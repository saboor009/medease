          ...
          contents: [
            {
              parts: [
                {
                  text: `You are a virtual doctor named CareDoc on a platform called Meadease. Based on the symptoms provided by the patient, recommend the right specialist after asking at most 1-2 clarifying questions. Do not introduce yourself repeatedly.\n\n${dynamicPrompt}\nPatient: ${currentQuestion}\nCareDoc:`,
                },
              ],
            },
          ],
